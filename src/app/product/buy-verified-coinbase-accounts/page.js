...
export default function BuyVerifiedCoinbaseAccounts() {
  ...
  const features = [
    ...
    "Verified accounts (USA, UK, CA & more)",
    "Bank account approved",
    "Complete verification documents provided",
    "Phone verified (any country)",
    "Coinbase email & password included",
    "Includes power bill copy & NID card",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-gradient-to-br from-orange-400 via-orange-500 to-yellow-400 rounded-xl p-6 h-full relative overflow-hidden shadow-lg">
              ...
              <div className="mt-12 mb-4">
                <h1 className="text-3xl font-bold leading-tight">
                  ...
                  <br />
                  <span className="text-black">COINBASE ACCOUNTS</span>
                </h1>
              </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-lg">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
              ...
              <span>Products</span>
              <span>/</span>
              <span className="text-gray-900">Coinbase Accounts</span>
            </div>
            ...
            {/* Price Range */}
            <div className="mb-4">
              <span className="text-3xl font-bold text-green-600">$180.00</span>
              <span className="text-gray-500 ml-2">- $380.00</span>
            </div>

            {/* Product Description */}
            <p className="text-gray-600 mb-6">
              Get fully verified Coinbase accounts from https://pvasupply.com/ —
              ready for instant trading, buying, selling, and storing
              cryptocurrencies like Bitcoin, Ethereum, and Litecoin. All
              accounts come with complete verification and documentation for
              safe, secure, and reliable use.
            </p>

            {/* Features List */}
            <div className="space-y-2 mb-6">
              <h3 className="text-base font-bold text-gray-900 mb-3">
                Features of Verified Coinbase Accounts:
              </h3>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    <option value="premium">Premium Package - $280.00</option>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="ml-2 text-gray-900">COINBASE-001</span>
                </div>
                <div>
            ...
            {activeTab === "description" && (
              <div className="prose max-w-none">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">
                  Verified Coinbase Accounts for Cryptocurrency Trading
                </h3>
                <p className="text-gray-600 mb-4">
                  Our verified Coinbase accounts are perfect for cryptocurrency
                  trading, digital asset management, and blockchain services.
                  Each account comes with full verification and established
                  history.
                </p>
                <p className="text-gray-600 mb-4">
                  Whether you need Coinbase accounts for crypto trading, digital
                  asset management, or blockchain services, our verified
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  <li>Fully verified Coinbase accounts</li>
