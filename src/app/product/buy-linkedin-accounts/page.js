...
export default function BuyLinkedInAccounts() {
  ...
  const dropdownOptions = [
    { value: "basic", label: "Basic Package - $30.00" },
    { value: "premium", label: "Premium Package - $140.00" },
    { value: "enterprise", label: "Enterprise Package - $250.00" },
  ];
              ...
              <div className="prose max-w-none">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center items-center my-8">
                    <Image
                      src="/images/long-description-photo/Buy LinkedIn Accounts.png"
                      alt="LinkedIn Accounts Description"
                      width={500}
                      height={350}
                    />
                  </div>
