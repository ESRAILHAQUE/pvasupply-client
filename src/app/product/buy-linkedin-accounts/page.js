          ...
          <div className="bg-white rounded-lg p-6 shadow-lg">
            ...
            <div className="mb-4 space-y-3">
              <p className="text-gray-700 text-sm">
                ...
                phone number verified old LinkedIn accounts? Or do you want to buy
                old PVA LinkedIn accounts with cheap price?
              </p>
              <p className="text-gray-700 text-sm">
            ...
            {activeTab === "description" && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  LinkedIn is a professional networking platform that allows users to connect with other professionals, share content, and build their professional brand. Our LinkedIn accounts are perfect for businesses and individuals who need to establish a professional online presence.
                </p>
                <p className="text-gray-700 mb-4">
