...
export default function BuyVerifiedBybitAccounts() {
  ...
  const dropdownOptions = [
    { value: "basic", label: "Basic Package - $170.00" },
    { value: "premium", label: "Premium Package - $220.00" },
    { value: "enterprise", label: "Enterprise Package - $270.00" },
  ];
              ...
              <div className="prose max-w-none">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center my-8">
                    <Image
                      src="/images/long-description-photo/Buy Verified Bybit Account.png"
                      alt="Bybit Accounts Description"
                      width={500}
                      height={350}
