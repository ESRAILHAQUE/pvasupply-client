      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="relative h-[600px] flex items-center justify-center bg-gray-50 rounded-xl shadow-lg">
            <Image
              src="/images/All Product/Buy Verified Stripe Accounts.png"
              alt="Stripe Accounts"
              width={500}
              height={500}
              ...
              <div className="prose max-w-none">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center my-8">
                    <Image
                      src="/images/long-description-photo/Buy Verified Stripe Accounts.png"
                      alt="Stripe Accounts Description"
                      width={500}
                      height={350}
