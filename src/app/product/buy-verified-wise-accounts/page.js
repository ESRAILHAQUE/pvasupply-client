            ...
            {activeTab === "description" && (
              <div className="prose max-w-none">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">
                  Verified Wise Accounts for International Banking
                </h3>
                <p className="text-gray-600 mb-4">
                  Our verified Wise accounts are perfect for international money
                  transfers, multi-currency banking, and global financial
                  services. Each account comes with full verification and
                  established history.
                </p>
                <p className="text-gray-600 mb-4">
                  Whether you need Wise accounts for international business,
                  personal transfers, or multi-currency banking, our verified
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  <li>Fully verified Wise accounts</li>
