...
export default function BuyVerifiedCashAppAccounts() {
  ...
  const dropdownOptions = [
    { value: "basic", label: "Basic Package - $160.00" },
    { value: "premium", label: "Premium Package - $305.00" },
    { value: "enterprise", label: "Enterprise Package - $450.00" },
  ];
              ...
              <div className="prose max-w-none">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center my-8">
                    <Image
                      src="/images/long-description-photo/Buy Verified Cash App Accounts.png"
                      alt="Cash App Accounts Description"
                      width={500}
                      height={350}
