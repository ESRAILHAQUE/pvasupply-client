...
const About = () => {
  // Animation variants - Scrolling Reveal
    ...
    <motion.div 
      ...
      <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <motion.div className="space-y-8" variants={leftContentVariants}>
          ...
          <motion.div
            ...
            <motion.div
              ...
              <motion.div
                className="absolute -top-4 -left-4 w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center shadow-lg"
              ...
              <motion.div
                className="absolute top-8 -right-4 w-14 h-14 bg-pink-500 rounded-full flex items-center justify-center shadow-lg"
                variants={floatingIconVariants}
                animate="animate"
              ...
              <motion.div
                className="absolute bottom-4 -left-6 w-12 h-12 bg-red-500 rounded-full flex items-center justify-center shadow-lg"
                variants={floatingIconVariants}
                animate="animate"
              ...
              <motion.div
                className="absolute top-1/2 right-8 w-10 h-10 bg-blue-700 rounded-full flex items-center justify-center shadow-lg"
                variants={floatingIconVariants}
                animate="animate"
