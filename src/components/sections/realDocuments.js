...
export default function RealDocuments() {
  return (
    <div className="flex items-center justify-center py-16 bg-[#FFFFFF] text-center overflow-hidden">
      <div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center">
          <button
            className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full text-sm sm:text-base font-semibold shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
            aria-label="Visit our shop to see all products">
            VISIT OUR SHOP
          </button>
